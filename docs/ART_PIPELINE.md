...
4. Run the script by entering the full path to it. For example:
   ...
   exec(open("C:/Path/To/Your/Repo/scripts/asset_generation/generate_urban_streetprops.py").read())
   ...
   exec(open("C:/Path/To/Your/Repo/scripts/asset_generation/generate_beach_extensions.py").read())
   ```
